...
namespace Lang {
    ...
    namespace Strings {
        ...
        constexpr const char* VERSION = "MusicAI ";
    ...
    namespace Sounds {
        ...
        extern const char ogg_alarm_beep_start[] asm("_binary_alarm_beep_ogg_start");
        extern const char ogg_alarm_beep_end[] asm("_binary_alarm_beep_ogg_end");
        static const std::string_view OGG_ALARM_BEEP {
        static_cast<const char*>(ogg_alarm_beep_start),
        static_cast<size_t>(ogg_alarm_beep_end - ogg_alarm_beep_start)
        };
